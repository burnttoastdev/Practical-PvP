execute as @e[type=minecraft:villager] if data entity @s {VillagerData:{profession:"minecraft:cleric"}} if data entity @s Offers.Recipes[7] run data remove entity @s Offers.Recipes[6]
